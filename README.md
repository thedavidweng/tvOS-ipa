...
- The application name, version, and plugin info are all connected by **underscores**. No trailing brand tag is added in this repo.

### Some Examples

`Air Twister (decrypted): AirTwister_1.4.0_Nothing.ipa`
...
- 应用程序名称、版本号和插件信息均由 **下划线** 连接。本仓库不在末尾加品牌标记。

### 一些例子

`Air Twister（仅砸壳）：AirTwister_1.4.0_Nothing.ipa`
